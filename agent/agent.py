        ...
        while True:
            with self._lock:
                if not self._pending_logs:
                    return
                # Take a snapshot of the current logs to send, max 400 at a time to respect server limits
                batch = self._pending_logs[:400]
            ...
            try:
                ...
                break  # Stop trying if we hit an error (e.g. network down)
