...
export const usersTable = pgTable("users", {
  ...
  pagePermissions: jsonb("page_permissions").$type<Record<
    ...
    "view" | "edit"
  > | null>(),
  // Data scoping for managers: device groups / regions this user is allowed to
  // see. NULL = unrestricted (all groups / regions). Only meaningful for the
  // "manager" role; ignored for admins. Values are the free-form group/region
  // strings used by devices and enrollment tokens.
  allowedGroups: text("allowed_groups").array(),
